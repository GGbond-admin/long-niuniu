...
const supremeSections: GameRuleDocumentInput['sections'] = [
  ...
  },
  {
    ...
    body:
      ...
      '2. 上庄 · 竞标庄钱\n' +
      '所有玩家可在倒计时内输入整数金额竞标庄钱；首口自由输入，之后最低需要比当前最高价高 RM100，也可以加更多，低于最低加价会被拒绝。最高出价者成为本局庄家，相应金额从余额中冻结作「庄池」。\n' +
  ...
  },
  {
    ...
    body:
      ...
      '相加超过 10 取个位；个位为 0（如相加为 20）显示为 10 点，是最大点数。',
  },
  {
    id: 'hands',
    title: '牌型与倍数（由高到低）',
    body:
      ...
      '反顺（14 倍）：三位数字连续递减，如 9.87 / 3.21 / 2.10；0.98 固定判反顺。\n' +
  ...
  },
  {
    ...
    title: '牌型比较规则',
    body:
      '先比牌型等级：豹子 ＞ 满牛 ＞ 反顺 ＞ 顺子 ＞ 对子 ＞ 金牛 ＞ 牛牛 ＞ 普通。\n' +
      '等级不同：高等级胜。\n' +
