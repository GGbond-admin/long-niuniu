  ...
  return (
    <div className="page detail-page rules-page">
      ...
      <RuleBlock title="游戏流程">
        <ol className="rules-steps">
          ...
          <li>
            ...
            <p>
              梭哈赔付固定 1:1，最低默认 RM30，房间上限为庄钱 × 满梭哈比例（后台可配，默认 5%），再与当前余额取较小值。
            </p>
          ...
          <li>
            ...
            <p>同牌型按该牌型规则比较；比较键相同再比整笔金额，完全相同庄家赢。</p>
          </li>
          <li>
      ...
      <RuleBlock title="牌型比较规则">
        ...
        <p>比较键相同：再比整笔金额，金额大者胜（例：10.50 赢 0.50）。</p>
        <p>完全相同：庄家赢（例：庄 1.22 对闲 1.22，庄赢）。</p>
        <p>免死（0.01）：本对判和，退回本金、不赔不赚。</p>
      </RuleBlock>
